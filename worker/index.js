export default {
  ...
  async scheduled(event, env, ctx) {
    ...
    const ALIASES = { 'Bosnia-H.': 'Bosnia and Herzegovina', 'Turkey': 'Türkiye', 'Ivory Coast': 'Côte d\u0027Ivoire', 'Curacao': 'Curaçao', 'Congo DR': 'DR Congo', 'Iran': 'IR Iran', 'Cape Verde': 'Cabo Verde' }
